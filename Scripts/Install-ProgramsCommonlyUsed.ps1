...
Install-WingetPackage --id=9PF4KZ2VN4W9 # TranslucentTB
...
Install-WingetPackage --id=KCSoftwares.SUMo
...
Install-WingetPackage --id=KDE.KDiff3 --scope=machine --interactive
Install-WingetPackage --id=qBittorrent.qBittorrent --interactive
